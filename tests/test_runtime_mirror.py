...
class RuntimeMirrorTests(unittest.TestCase):
    def test_runtime_mirror_manifest_has_explicit_entries(self):
        ...
        self.assertIn("core/relation_visualization_exporter.py", patterns)
        self.assertIn("core/runtime_parts.py", patterns)
        self.assertIn("core/relation_store.py", patterns)
        self.assertIn("core/session_store.py", patterns)
